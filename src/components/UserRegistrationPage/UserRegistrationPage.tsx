...
import { Container, Card, Col, Form, Alert, Button, Row } from "react-bootstrap";
...
export class UserRegistrationPage extends React.Component {
    ...
    private renderRegistrationCompleteMessage() {
        return (
            <p>
                The acount has been registered.
                <br />
    ...
    private doRegister() {
        ...
        api("auth/user/register", "post", data).then((res: ApiResponse) => {
            if (res.status === "error") {
