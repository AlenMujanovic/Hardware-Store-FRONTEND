...
class AdministratorDashboardArticle extends React.Component {
    ...
    private async getFeaturesByCategoryId(categoryId: number): Promise<FeatureBaseType[]> {
        return new Promise((resolve) => {
            api("/api/feature/?filter=categoryId||$eq||" + categoryId + "/", "get", {}, "administrator").then(
                (res: ApiResponse) => {
    ...
    private getArticles() {
        api(
            "/api/article/?join=articleFeatures&join=features&join=articlePrices&join=photos&join=category",
            "get",
            {},
            "administrator"
        ...
        return (
            <Container>
                ...
                <Modal
                    size="lg"
                    centered
                    show={this.state.addModal.visible}
                    ...
                    <Modal.Body>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control
                                ...
                                onChange={(e) =>
                                    this.setAddModalStringFieldState("description", e.target.value)
                                }
                                rows={10}
                            />
                        </Form.Group>
                        ...
                        <div>{this.state.addModal.features.map(this.printAddModalFeatureInput, this)}</div>
                ...
                <Modal
                    size="lg"
                    centered
                    show={this.state.editModal.visible}
                    ...
                    <Modal.Body>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control
                                ...
                                onChange={(e) =>
                                    this.setEditModalStringFieldState("description", e.target.value)
                                }
                                rows={10}
                            />
                        </Form.Group>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control
                                ...
                                onChange={(e) =>
                                    this.setEditModalNumberFieldState("isPromoted", e.target.value)
                                }
                            >
                        ...
                        <div>{this.state.editModal.features.map(this.printEditModalFeatureInput, this)}</div>
    ...
    private doEditArticle() {
        api(
            "/api/article/" + this.state.editModal.articleId,
            "patch",
            {
