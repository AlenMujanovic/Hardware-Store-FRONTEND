...
class AdministratorDashboardPhoto extends React.Component<AdministratorDashboardPhotoProperties> {
    ...
    private getPhotos() {
        api("/api/article/" + this.props.match.params.aId + "/?join=photos", "get", {}, "administrator").then(
            (res: ApiResponse) => {
            ...
            <Container>
                ...
                <Card>
                    <Card.Body>
                        ...
                        <Row>{this.state.photos.map(this.printSinglePhoto, this)}</Row>
    ...
    private deletePhoto(photoId: number) {
        ...
        api(
            "/api/article/" + this.props.match.params.aId + "/deletePhoto/" + photoId + "/",
            "delete",
            {},
            "administrator"
