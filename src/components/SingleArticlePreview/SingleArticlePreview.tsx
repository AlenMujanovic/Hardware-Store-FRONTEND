            ...
            <Col lg="4" md="6" sm="6" xs="12">
                <Card className="mb-3">
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>Price: {Number(this.props.article.price).toFixed(2)} EUR</Card.Text>
                        <Form.Group>
                            <Row>
                                <Col xs="7">
                                    <Form.Control
                                ...
                                <Col xs="5">
                                    <Button variant="secondary" onClick={() => this.addToCart()}>
                                        Buy
                                    </Button>
                                </Col>
                            </Row>
                        ...
                        <Link
                            to={`/article/${this.props.article.articleId}`}
